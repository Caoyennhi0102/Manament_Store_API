...
namespace Manament_Store_API.Controllers
{
    public class LoginController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            var loginImage = _sqlConnectionDatabase.ImageSettings
                                    .FirstOrDefault(i => i.DuLieuAnh == "LoginImage")?.DuongDanAnh
                             ?? "/Image/Uploads/login-default.png";

            // Truyền vào View qua ViewBag
            ViewBag.LoginImage = loginImage;
